...
st.title("NoctiVision.AI - A Flare Removal AI 🌠")
...
if uploaded_file:
    ...
    with st.spinner("Processing..."):
        ...
        # Apply refinements
        output_np_resized = sharpen_image(output_np_resized)
        output_np_resized = apply_clahe(output_np_resized)

    st.image(output_np_resized, caption="Flare-Free, Enhanced Output", use_column_width=True)
